...
def main():
	vcd_file, start_time, end_time, csv = sys.argv[1], sys.argv[2], sys.argv[3], sys.argv[4]

	write_file = parse_vcd(vcd_file, start_time, end_time, csv)		# vcd = record all time's signals
	#for p in write_file:
	#	print p
	f = open('t1.vcd','w')
